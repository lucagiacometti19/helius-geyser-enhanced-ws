...
pub fn fetch_all_global_volume_accumulator(
  ...
  addresses: &[solana_pubkey::Pubkey],
    ...
    let mut decoded_accounts: Vec<crate::shared::DecodedAccount<GlobalVolumeAccumulator>> = Vec::new();
...
pub fn fetch_all_maybe_global_volume_accumulator(
  ...
  addresses: &[solana_pubkey::Pubkey],
    ...
    let accounts = rpc.get_multiple_accounts(addresses)
      .map_err(|e| std::io::Error::new(std::io::ErrorKind::Other, e.to_string()))?;
    let mut decoded_accounts: Vec<crate::shared::MaybeAccount<GlobalVolumeAccumulator>> = Vec::new();
    for i in 0..addresses.len() {
      let address = addresses[i];
