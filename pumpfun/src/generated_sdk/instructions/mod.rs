...
//!
  ...
  pub(crate) mod r#claim_cashback;
  ...
  pub(crate) mod r#distribute_creator_fees;
  pub(crate) mod r#extend_account;
  pub(crate) mod r#get_minimum_distributable_fee;
  pub(crate) mod r#initialize;
  pub(crate) mod r#init_user_volume_accumulator;
  pub(crate) mod r#migrate;
  pub(crate) mod r#migrate_bonding_curve_creator;
  pub(crate) mod r#sell;
  pub(crate) mod r#set_creator;
  pub(crate) mod r#set_mayhem_virtual_params;
  ...
  pub(crate) mod r#toggle_cashback_enabled;
  ...
  pub use self::r#distribute_creator_fees::*;
  pub use self::r#extend_account::*;
  pub use self::r#get_minimum_distributable_fee::*;
  pub use self::r#initialize::*;
  pub use self::r#init_user_volume_accumulator::*;
  pub use self::r#migrate::*;
  pub use self::r#migrate_bonding_curve_creator::*;
  pub use self::r#sell::*;
  pub use self::r#set_creator::*;
  pub use self::r#set_mayhem_virtual_params::*;
  ...
  pub use self::r#toggle_cashback_enabled::*;
