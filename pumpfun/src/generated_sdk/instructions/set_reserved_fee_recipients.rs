...
pub const SET_RESERVED_FEE_RECIPIENTS_DISCRIMINATOR: [u8; 8] = [111, 172, 162, 232, 114, 89, 213, 142];
...
impl SetReservedFeeRecipients {
  pub fn instruction(&self, args: SetReservedFeeRecipientsInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetReservedFeeRecipientsInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = SetReservedFeeRecipientsInstructionData::new().try_to_vec().unwrap();
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetReservedFeeRecipients {
          ...
          let args = SetReservedFeeRecipientsInstructionArgs {
                                                              whitelist_pda: self.whitelist_pda.clone().expect("whitelist_pda is not set"),
                                    };
...
impl<'a, 'b> SetReservedFeeRecipientsCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = SetReservedFeeRecipientsInstructionArgs {
                                                              whitelist_pda: self.instruction.whitelist_pda.clone().expect("whitelist_pda is not set"),
                                    };
