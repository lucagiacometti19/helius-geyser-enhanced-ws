...
pub const DISTRIBUTE_CREATOR_FEES_DISCRIMINATOR: [u8; 8] = [165, 114, 103, 0, 121, 206, 247, 81];
...
impl DistributeCreatorFees {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = DistributeCreatorFeesInstructionData::new().try_to_vec().unwrap();
...
/// Instruction builder for `DistributeCreatorFees`.
///
/// ### Accounts:
///
          ///   0. `[]` mint
          ///   1. `[]` bonding_curve
          ///   2. `[]` sharing_config
                ///   3. `[writable]` creator_vault
                ///   4. `[optional]` system_program (default to `11111111111111111111111111111111`)
          ///   5. `[]` event_authority
                ///   6. `[optional]` program (default to `6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P`)
...
#[inline(always)]
  ...
  /// `distribute_creator_fees` CPI accounts.
...
/// `distribute_creator_fees` CPI instruction.
...
/// Instruction builder for `DistributeCreatorFees` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` mint
