...
pub const CLOSE_USER_VOLUME_ACCUMULATOR_DISCRIMINATOR: [u8; 8] = [249, 69, 164, 218, 150, 103, 84, 138];
...
impl CloseUserVolumeAccumulator {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = CloseUserVolumeAccumulatorInstructionData::new().try_to_vec().unwrap();
