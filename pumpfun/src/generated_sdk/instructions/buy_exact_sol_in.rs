...
impl BuyExactSolIn {
  pub fn instruction(&self, args: BuyExactSolInInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: BuyExactSolInInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    ...
    pub fn global_volume_accumulator(&mut self, global_volume_accumulator: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn user_volume_accumulator(&mut self, user_volume_accumulator: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = BuyExactSolIn {
                              global: self.global.expect("global is not set"),
                                        ...
                                        program: self.program.unwrap_or(solana_pubkey::pubkey!("6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P")),
                                        global_volume_accumulator: self.global_volume_accumulator.expect("global_volume_accumulator is not set"),
                                        user_volume_accumulator: self.user_volume_accumulator.expect("user_volume_accumulator is not set"),
                                        fee_config: self.fee_config.expect("fee_config is not set"),
                                        fee_program: self.fee_program.unwrap_or(solana_pubkey::pubkey!("pfeeUxB6jkeY1Hxd7CsFCAjcbHA9rWtchMGdZ6VojVZ")),
                      };
          let args = BuyExactSolInInstructionArgs {
                                                              spendable_sol_in: self.spendable_sol_in.clone().expect("spendable_sol_in is not set"),
                                                                  min_tokens_out: self.min_tokens_out.clone().expect("min_tokens_out is not set"),
...
impl<'a, 'b> BuyExactSolInCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn associated_bonding_curve(&mut self, associated_bonding_curve: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn associated_user(&mut self, associated_user: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn global_volume_accumulator(&mut self, global_volume_accumulator: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn user_volume_accumulator(&mut self, user_volume_accumulator: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_volume_accumulator = Some(user_volume_accumulator);
                    self
    }
      #[inline(always)]
    pub fn fee_config(&mut self, fee_config: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.fee_config = Some(fee_config);
                    self
    }
      #[inline(always)]
    pub fn fee_program(&mut self, fee_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = BuyExactSolInInstructionArgs {
                                                              spendable_sol_in: self.instruction.spendable_sol_in.clone().expect("spendable_sol_in is not set"),
                                                                  min_tokens_out: self.instruction.min_tokens_out.clone().expect("min_tokens_out is not set"),
                                                                  track_volume: self.instruction.track_volume.clone().expect("track_volume is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          user_volume_accumulator: self.instruction.user_volume_accumulator.expect("user_volume_accumulator is not set"),
                  
          fee_config: self.instruction.fee_config.expect("fee_config is not set"),
                  
          fee_program: self.instruction.fee_program.expect("fee_program is not set"),
                          __args: args,
            };
