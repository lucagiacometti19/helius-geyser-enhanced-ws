...
impl SetCreator {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: SetCreatorInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl SetCreatorBuilder {
  pub fn new() -> Self {
    Self::default()
            ...
            #[inline(always)]
    pub fn set_creator_authority(&mut self, set_creator_authority: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetCreator {
                              set_creator_authority: self.set_creator_authority.expect("set_creator_authority is not set"),
...
impl<'a, 'b> SetCreatorCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn set_creator_authority(&mut self, set_creator_authority: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          set_creator_authority: self.instruction.set_creator_authority.expect("set_creator_authority is not set"),
