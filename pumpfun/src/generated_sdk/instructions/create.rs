...
impl Create {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: CreateInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Create {
                              mint: self.mint.expect("mint is not set"),
                                        ...
                                        mpl_token_metadata: self.mpl_token_metadata.unwrap_or(solana_pubkey::pubkey!("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s")),
...
impl<'a, 'b> CreateCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn global(&mut self, global: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn mpl_token_metadata(&mut self, mpl_token_metadata: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
