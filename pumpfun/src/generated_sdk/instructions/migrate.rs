...
impl MigrateBuilder {
  pub fn new() -> Self {
    ...
    pub fn bonding_curve(&mut self, bonding_curve: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn associated_bonding_curve(&mut self, associated_bonding_curve: solana_pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
    ...
    pub fn pool_authority(&mut self, pool_authority: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn pool_authority_mint_account(&mut self, pool_authority_mint_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.pool_authority_mint_account = Some(pool_authority_mint_account);
                    self
    }
            #[inline(always)]
    pub fn pool_authority_wsol_account(&mut self, pool_authority_wsol_account: solana_pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
    ...
    pub fn lp_mint(&mut self, lp_mint: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn user_pool_token_account(&mut self, user_pool_token_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.user_pool_token_account = Some(user_pool_token_account);
                    self
    }
            #[inline(always)]
    pub fn pool_base_token_account(&mut self, pool_base_token_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.pool_base_token_account = Some(pool_base_token_account);
                    self
    }
            #[inline(always)]
    pub fn pool_quote_token_account(&mut self, pool_quote_token_account: solana_pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
    pub fn associated_token_program(&mut self, associated_token_program: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn pump_amm_event_authority(&mut self, pump_amm_event_authority: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Migrate {
                              global: self.global.expect("global is not set"),
                                        ...
                                        pump_amm: self.pump_amm.unwrap_or(solana_pubkey::pubkey!("pAMMBay6oceH9fJKBRHGP5D4bD4sWpmSwMn52FMfXEA")),
                                        pool: self.pool.expect("pool is not set"),
                                        pool_authority: self.pool_authority.expect("pool_authority is not set"),
                                        pool_authority_mint_account: self.pool_authority_mint_account.expect("pool_authority_mint_account is not set"),
                                        pool_authority_wsol_account: self.pool_authority_wsol_account.expect("pool_authority_wsol_account is not set"),
                                        amm_global_config: self.amm_global_config.expect("amm_global_config is not set"),
                                        wsol_mint: self.wsol_mint.unwrap_or(solana_pubkey::pubkey!("So11111111111111111111111111111111111111112")),
                                        ...
                                        pool_base_token_account: self.pool_base_token_account.expect("pool_base_token_account is not set"),
                                        pool_quote_token_account: self.pool_quote_token_account.expect("pool_quote_token_account is not set"),
                                        ...
                                        pump_amm_event_authority: self.pump_amm_event_authority.expect("pump_amm_event_authority is not set"),
...
impl<'a, 'b> MigrateCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn global(&mut self, global: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn withdraw_authority(&mut self, withdraw_authority: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn bonding_curve(&mut self, bonding_curve: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn associated_bonding_curve(&mut self, associated_bonding_curve: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn pool(&mut self, pool: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn pool_authority(&mut self, pool_authority: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_authority = Some(pool_authority);
                    self
    }
      #[inline(always)]
    pub fn pool_authority_mint_account(&mut self, pool_authority_mint_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_authority_mint_account = Some(pool_authority_mint_account);
                    self
    }
      #[inline(always)]
    pub fn pool_authority_wsol_account(&mut self, pool_authority_wsol_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_authority_wsol_account = Some(pool_authority_wsol_account);
                    self
    }
      #[inline(always)]
    pub fn amm_global_config(&mut self, amm_global_config: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn lp_mint(&mut self, lp_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn user_pool_token_account(&mut self, user_pool_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_pool_token_account = Some(user_pool_token_account);
                    self
    }
      #[inline(always)]
    pub fn pool_base_token_account(&mut self, pool_base_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_base_token_account = Some(pool_base_token_account);
                    self
    }
      #[inline(always)]
    pub fn pool_quote_token_account(&mut self, pool_quote_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn associated_token_program(&mut self, associated_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn pump_amm_event_authority(&mut self, pump_amm_event_authority: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          pool_authority: self.instruction.pool_authority.expect("pool_authority is not set"),
                  
          pool_authority_mint_account: self.instruction.pool_authority_mint_account.expect("pool_authority_mint_account is not set"),
                  
          pool_authority_wsol_account: self.instruction.pool_authority_wsol_account.expect("pool_authority_wsol_account is not set"),
                  
          amm_global_config: self.instruction.amm_global_config.expect("amm_global_config is not set"),
          ...
          pool_base_token_account: self.instruction.pool_base_token_account.expect("pool_base_token_account is not set"),
                  
          pool_quote_token_account: self.instruction.pool_quote_token_account.expect("pool_quote_token_account is not set"),
          ...
          pump_amm_event_authority: self.instruction.pump_amm_event_authority.expect("pump_amm_event_authority is not set"),
