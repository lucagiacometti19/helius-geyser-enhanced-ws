...
impl AdminSetCreator {
  pub fn instruction(&self, args: AdminSetCreatorInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AdminSetCreatorInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl AdminSetCreatorBuilder {
  pub fn new() -> Self {
    Self::default()
            ...
            #[inline(always)]
    pub fn admin_set_creator_authority(&mut self, admin_set_creator_authority: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = AdminSetCreator {
                              admin_set_creator_authority: self.admin_set_creator_authority.expect("admin_set_creator_authority is not set"),
...
impl<'a, 'b> AdminSetCreatorCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn admin_set_creator_authority(&mut self, admin_set_creator_authority: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          admin_set_creator_authority: self.instruction.admin_set_creator_authority.expect("admin_set_creator_authority is not set"),
