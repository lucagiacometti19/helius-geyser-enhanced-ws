...
impl Sell {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: SellInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let accounts = Sell {
          ...
          let args = SellInstructionArgs {
                                                              amount: self.amount.clone().expect("amount is not set"),
                                                                  min_sol_output: self.min_sol_output.clone().expect("min_sol_output is not set"),
                                    };
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = SellInstructionArgs {
                                                              amount: self.instruction.amount.clone().expect("amount is not set"),
                                                                  min_sol_output: self.instruction.min_sol_output.clone().expect("min_sol_output is not set"),
                                    };
