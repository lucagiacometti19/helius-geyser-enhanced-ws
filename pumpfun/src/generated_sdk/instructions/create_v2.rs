...
impl CreateV2 {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: CreateV2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CreateV2 {
                              mint: self.mint.expect("mint is not set"),
                                        ...
                                        mayhem_program_id: self.mayhem_program_id.unwrap_or(solana_pubkey::pubkey!("MAyhSmzXzV1pTf7LsNkrNwkWKTo4ougAJ1PPg47MD4e")),
...
impl<'a, 'b> CreateV2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn associated_token_program(&mut self, associated_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn mayhem_program_id(&mut self, mayhem_program_id: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.mayhem_program_id = Some(mayhem_program_id);
                    self
    }
      #[inline(always)]
    pub fn global_params(&mut self, global_params: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn sol_vault(&mut self, sol_vault: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn mayhem_state(&mut self, mayhem_state: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          mayhem_program_id: self.instruction.mayhem_program_id.expect("mayhem_program_id is not set"),
                  
          global_params: self.instruction.global_params.expect("global_params is not set"),
                  
          sol_vault: self.instruction.sol_vault.expect("sol_vault is not set"),
                  
          mayhem_state: self.instruction.mayhem_state.expect("mayhem_state is not set"),
