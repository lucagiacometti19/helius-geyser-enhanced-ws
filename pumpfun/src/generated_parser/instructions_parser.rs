        ...
        let ix_data = &ix.data[8..];
            let ix = match ix_discriminator {
                            ...
                            let ix_accounts = AdminSetCreatorIxAccounts{
                                                            ...
                                                            let de_ix_data:AdminSetCreatorIxData = deserialize_checked(ix_data, &ix_discriminator)?;
                            ...
                            let ix_accounts = AdminSetIdlAuthorityIxAccounts{
                                                            ...
                                                            let de_ix_data:AdminSetIdlAuthorityIxData = deserialize_checked(ix_data, &ix_discriminator)?;
                            ...
                            let ix_accounts = AdminUpdateTokenIncentivesIxAccounts{
                                                            ...
                                                            let de_ix_data:AdminUpdateTokenIncentivesIxData = deserialize_checked(ix_data, &ix_discriminator)?;
                                Ok(PumpProgramIx::AdminUpdateTokenIncentives(ix_accounts, de_ix_data))
                                                    },
                            ...
                            let ix_accounts = SetReservedFeeRecipientsIxAccounts{
                                                            ...
                                                            let de_ix_data:SetReservedFeeRecipientsIxData = deserialize_checked(ix_data, &ix_discriminator)?;
                                Ok(PumpProgramIx::SetReservedFeeRecipients(ix_accounts, de_ix_data))
                                                    },
                            ...
                            let ix_accounts = ToggleCreateV2IxAccounts{
                                                            ...
                                                            let de_ix_data:ToggleCreateV2IxData = deserialize_checked(ix_data, &ix_discriminator)?;
                            ...
                            let ix_accounts = ToggleMayhemModeIxAccounts{
                                                            ...
                                                            let de_ix_data:ToggleMayhemModeIxData = deserialize_checked(ix_data, &ix_discriminator)?;
...
mod proto_parser {
    use super::{InstructionParser,PumpProgramIx};
        ...
        impl IntoProto<proto_def::AdminUpdateTokenIncentivesIxAccounts> for AdminUpdateTokenIncentivesIxAccounts  {
        ...
        impl IntoProto<proto_def::CloseUserVolumeAccumulatorIxAccounts> for CloseUserVolumeAccumulatorIxAccounts  {
        ...
        impl IntoProto<proto_def::InitUserVolumeAccumulatorIxAccounts> for InitUserVolumeAccumulatorIxAccounts  {
        ...
        impl IntoProto<proto_def::SetReservedFeeRecipientsIxAccounts> for SetReservedFeeRecipientsIxAccounts  {
        ...
        impl IntoProto<proto_def::SyncUserVolumeAccumulatorIxAccounts> for SyncUserVolumeAccumulatorIxAccounts  {
    ...
    impl IntoProto<proto_def::ProgramIxs> for PumpProgramIx {
        fn into_proto(self) -> proto_def::ProgramIxs {
           match self {
                            ...
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::AdminSetCreator(proto_def::AdminSetCreatorIx {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::AdminSetIdlAuthority(acc, data) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::AdminSetIdlAuthority(proto_def::AdminSetIdlAuthorityIx {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::AdminUpdateTokenIncentives(acc, data) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::AdminUpdateTokenIncentives(proto_def::AdminUpdateTokenIncentivesIx {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                            ...
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::BuyExactSolIn(proto_def::BuyExactSolInIx {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                            ...
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::CloseUserVolumeAccumulator(proto_def::CloseUserVolumeAccumulatorIx {
                                accounts: Some(acc.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::CollectCreatorFee(acc) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::CollectCreatorFee(proto_def::CollectCreatorFeeIx {
                                accounts: Some(acc.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::Create(acc, data) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::Create(proto_def::CreateIx {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::CreateV2(acc, data) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::CreateV2(proto_def::CreateV2Ix {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                            ...
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::InitUserVolumeAccumulator(proto_def::InitUserVolumeAccumulatorIx {
                                accounts: Some(acc.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::Initialize(acc) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::Initialize(proto_def::InitializeIx {
                                accounts: Some(acc.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::Migrate(acc) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::Migrate(proto_def::MigrateIx {
                                accounts: Some(acc.into_proto()),
                            })),
                        },
                            ...
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::SetMetaplexCreator(proto_def::SetMetaplexCreatorIx {
                                accounts: Some(acc.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::SetParams(acc, data) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::SetParams(proto_def::SetParamsIx {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::SetReservedFeeRecipients(acc, data) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::SetReservedFeeRecipients(proto_def::SetReservedFeeRecipientsIx {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                            ...
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::ToggleCreateV2(proto_def::ToggleCreateV2Ix {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::ToggleMayhemMode(acc, data) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::ToggleMayhemMode(proto_def::ToggleMayhemModeIx {
                                accounts: Some(acc.into_proto()),
                                data: Some(data.into_proto()),
                            })),
                        },
                                                                                PumpProgramIx::UpdateGlobalAuthority(acc) => proto_def::ProgramIxs {
                            ix_oneof: Some(proto_def::program_ixs::IxOneof::UpdateGlobalAuthority(proto_def::UpdateGlobalAuthorityIx {
                                accounts: Some(acc.into_proto()),
                            })),
                        },
                                                }
